...
Edit `daacs.properties`.

You can change the password for MongoDB in `start/daacs.properties` and `install/mongo-user.script.js`. However, we recommend blocking access to the MongoDB to all IP addresses.
